...
function check_hall_plan ($post_id) {  
	/* 
	Функция определяет, нужно ли вывести надпись "План зала" под постом афиши.
	...
	*/
	...
	if ($posttags) {
		foreach($posttags as $tag) {
			$my_tmp = $tag->name; 
			if($my_tmp == 'План зала'){$key = 0;} /* вместо test ввести метку, по которой нужно вывести надпись "План зала" */
		}
	}
